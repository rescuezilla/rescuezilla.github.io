...
<li><span class="menu_current"><a href="http://redobackup.org/help.php" target="_top"  class="menu_current"> Help </a></span>
  ...
  <div id="content">
    <a class="section_anchor" id="wb_9" name="wb_9"></a><h1><img align="right" width="128" height="128" alt="" style="margin-left: 20px;" src="http://redobackup.org/media/icons/help.png" />Need Help?</h1>
...
<div><a target="_blank" href="http://wizardprints.com"><img border="0" align="right" width="150" height="375" style="margin: 0px 0px 10px 20px; border: medium none;" alt="digital photo enlargements" src="http://redobackup.org/media/ads/wp-ad-1.jpg" /></a></div>
...
<h3>Q:&nbsp;How can I&nbsp;see the commands, output, or errors (debug mode)?</h3>
<p style="margin-left: 40px;">A: Boot into Redo. Right-click the Redo icon at the bottom of the screen and CLOSE&nbsp;it. Then click the menu button and select Tools &gt;&nbsp;Terminal. In the terminal window, type <strong>redobackup</strong> and hit ENTER. This will launch Redo again, but the terminal window will stay open, allowing you to see all the background commands, output, and any errors generated in the process. If you are having trouble restoring, pay special attention to the terminal window when the restore begins; this is when the partition table is being written and the filesystems are being created.</p>
